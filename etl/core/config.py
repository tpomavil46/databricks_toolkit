...
class PipelineConfig:
    ...
    validation_config: ValidationConfig = field(default_factory=ValidationConfig.from_env)
    ...
    def from_dict(cls, config_dict: Dict[str, Any]) -> 'PipelineConfig':
        ...
        return cls(
            ...
            table_config=TableConfig(**config_dict.get('table', {})) if 'table' in config_dict else None,
...
@log_function_call
def create_default_config(project_name: str, environment: str = "dev") -> PipelineConfig:
