...
def test_silver_transformation(bronze_table):
    ...
    try:
        ...
        results = pipeline.run_silver_transformation(bronze_table, transformations=transformations, auto_drop=True)
...
def test_gold_aggregation(silver_table):
    ...
    try:
        ...
        results = pipeline.run_gold_aggregation(silver_table, aggregations=aggregations, auto_drop=True)
...
def test_individual_jobs():
    ...
    try:
        ...
        bronze_results = bronze_job.run("dbfs:/databricks-datasets/retail-org/customers/", auto_drop=True)
...
def test_full_pipeline():
    ...
    try:
        ...
        results = pipeline.run_full_pipeline(source_path, transformations, aggregations, auto_drop=True)
...
def main():
    ...
    if passed == total:
        print("🎉 All data tests passed! ETL framework is working correctly with real data.")
        return True
    else:
