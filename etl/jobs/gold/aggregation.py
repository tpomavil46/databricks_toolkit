...
class GoldAggregationJob:
    ...
    def run(self, source_table: str, table_name: str = None,
            aggregations: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        ...
        try:
            results = self.pipeline.run_gold_aggregation(source_table, table_name, aggregations)
...
def run_gold_aggregation_job(project_name: str, source_table: str,
