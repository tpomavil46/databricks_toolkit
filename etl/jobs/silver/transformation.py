...
class SilverTransformationJob:
    ...
    @log_function_call
    def run(self, source_table: str, table_name: str = None, 
            transformations: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        ...
        try:
            results = self.pipeline.run_silver_transformation(source_table, table_name, transformations)
    ...
    @log_function_call
    def run_with_validation(self, source_table: str, table_name: str = None,
                          transformations: Dict[str, Any] = None) -> Dict[str, Any]:
        """
...
def run_silver_transformation_job(project_name: str, source_table: str,
                                environment: str = "dev", table_name: str = None,
                                transformations: Dict[str, Any] = None) -> Dict[str, Any]:
    """
