...
class BronzeIngestionJob:
    ...
    @log_function_call
    def run(self, source_path: str, table_name: str = None, auto_drop: bool = False) -> Dict[str, Any]:
        """
        ...
        try:
            results = self.pipeline.run_bronze_ingestion(source_path, table_name, auto_drop)
    ...
    @log_function_call
    def run_with_validation(self, source_path: str, table_name: str = None, auto_drop: bool = False) -> Dict[str, Any]:
        """
...
def run_bronze_ingestion_job(project_name: str, source_path: str, 
                            environment: str = "dev", table_name: str = None, auto_drop: bool = False) -> Dict[str, Any]:
    """
