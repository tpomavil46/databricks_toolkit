...
class ClusterManager:
    ...
    @log_function_call
    def create_cluster(self, cluster_name: str, spark_version: str = "13.3.x-scala2.12",
                      node_type_id: str = "i3.xlarge", num_workers: int = 1,
                      autotermination_minutes: int = 60) -> Dict[str, Any]:
        """
    ...
    def get_cluster_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            reasonable_autotermination = len([c for c in clusters if c.autotermination_minutes and c.autotermination_minutes <= 120])
            ...
            if total_clusters > 0:
                ...
                if autotermination_ratio < 0.8:
                    issues.append(f"Low autotermination coverage: {autotermination_ratio:.1%}")
                    health_score += 15
                else:
                    health_score += 30
            else:
            ...
            return {
                ...
                'metrics': {
                    ...
                    'running_ratio': running_clusters / total_clusters if total_clusters > 0 else 0,
                    'autotermination_ratio': reasonable_autotermination / total_clusters if total_clusters > 0 else 0
                },
                'issues': issues
            }
    ...
    def get_cluster_usage_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            autotermination_enabled = len([c for c in clusters if c.autotermination_minutes and c.autotermination_minutes > 0])
            
            # Calculate average autotermination time
            autotermination_times = [c.autotermination_minutes for c in clusters if c.autotermination_minutes]
            avg_autotermination = sum(autotermination_times) / len(autotermination_times) if autotermination_times else 0
            ...
            return {
                ...
                'utilization_rate': running_clusters / total_clusters if total_clusters > 0 else 0
            }
