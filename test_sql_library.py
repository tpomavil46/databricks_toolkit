...
def test_sql_patterns():
    ...
    try:
        bronze_pattern = patterns.render_pattern('bronze_ingestion', {
...
def test_data_quality():
    ...
    try:
        null_check = quality.render_check('null_check', {
...
def test_sql_templates():
    ...
    try:
        bronze_silver_template = templates.render_template('bronze_to_silver_pipeline', {
            'catalog': 'hive_metastore',
            'schema': 'retail',
            'table_name': 'customers',
