...
def from_avro(
    ...
    if typecheck_enabled:
        ...
        if jsonFormatSchema is not None and not isinstance(jsonFormatSchema, str):
            raise PySparkTypeError(
                error_class="INVALID_TYPE",
                message_parameters={"arg_name": "jsonFormatSchema", "arg_type": "str, optional"},
            )
        ...
        if subject is not None and not isinstance(subject, str):
            raise PySparkTypeError(
                error_class="INVALID_TYPE",
                message_parameters={"arg_name": "subject", "arg_type": "str, optional"},
            )
        if schemaRegistryAddress is not None and not isinstance(schemaRegistryAddress, str):
            raise PySparkTypeError(
                error_class="INVALID_TYPE",
                message_parameters={"arg_name": "schemaRegistryAddress", "arg_type": "str, optional"},
            )
