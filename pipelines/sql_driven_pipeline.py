...
class SQLDrivenPipeline:
    ...
    @log_function_call
    def run_bronze(
        self, input_path: str, bronze_table: str, file_format: str = "delta"
    ) -> None:
        """
        ...
        sql_file = (
            ...
            / "bronze"
            / self.project
            / self.sql_files[self.project]["bronze"]
        )
    ...
    @log_function_call
    def run_silver(
        self, bronze_table: str, silver_table: str, vendor_filter: Optional[int] = None
    ) -> None:
        """
        ...
        sql_file = (
            ...
            / "silver"
            / self.project
            / self.sql_files[self.project]["silver"]
        )
    ...
    @log_function_call
    def run_gold(
        self, silver_table: str, gold_table: str, vendor_filter: Optional[int] = None
    ) -> None:
        """
        ...
        sql_file = (
            ...
            / "gold"
            / self.project
            / self.sql_files[self.project]["gold"]
        )
