...
def main():
    ...
    costs_parser.add_argument(
        "--year", type=int, default=datetime.now().year, help="Year (default: current)"
    )
    costs_parser.add_argument(
        "--month",
        type=int,
    ...
    report_parser = subparsers.add_parser(
        "report", help="Generate comprehensive cost report"
    )
    ...
    check_parser.add_argument(
        "--threshold", type=float, default=100.0, help="Cost threshold in dollars"
    )
