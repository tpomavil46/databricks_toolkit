...
class DLTPipelineRunner:
    ...
    @log_function_call
    def execute_dlt_bronze_ingestion(
        self,
        source_path: str,
        table_name: str,
    ...
    @log_function_call
    def execute_dlt_silver_transformation(
        self, bronze_table: str, silver_table: str
    ) -> None:
        """
        ...
        parameters = {"bronze_table": bronze_table, "silver_table": silver_table}
    ...
    def execute_dlt_gold_aggregation(self, silver_table: str, gold_table: str) -> None:
        ...
        parameters = {"silver_table": silver_table, "gold_table": gold_table}
    ...
    @log_function_call
    def execute_dlt_cdc_processing(
        self, bronze_table: str, silver_table: str, key_column: str
    ) -> None:
        """
    ...
    @log_function_call
    def run_complete_dlt_pipeline(
        self, project: str, source_path: str, environment: str = "dev"
    ) -> None:
        """
        ...
        self.execute_dlt_bronze_ingestion(
            source_path=source_path, table_name=bronze_table, file_format="json"
        )
        ...
        self.execute_dlt_gold_aggregation(
            silver_table=silver_table, gold_table=gold_table
        )
