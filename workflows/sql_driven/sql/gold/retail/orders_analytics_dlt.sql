-- DLT Orders Analytics (Based on Training Example)
-- This demonstrates DLT-specific syntax for gold layer analytics with materialized views
-- Parameters: ${silver_table}

-- DLT Materialized View for Orders Analytics
CREATE OR REFRESH MATERIALIZED VIEW orders_by_date
COMMENT "Gold layer orders analytics for business insights"
