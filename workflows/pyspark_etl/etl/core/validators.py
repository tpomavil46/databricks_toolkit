...
class DataValidator:
    ...
    def _get_schema_info(self, df: DataFrame) -> Dict[str, Any]:
        ...
        schema_info = {"columns": [], "data_types": {}, "nullable_columns": []}
    ...
    def _analyze_nulls(self, df: DataFrame) -> Dict[str, Any]:
        ...
        for column in df.columns:
            ...
            null_analysis[column] = {
                ...
                "exceeds_threshold": null_percentage
                > self.config.validation_config.null_threshold * 100,
            }
    ...
    def _check_primary_key(self, df: DataFrame) -> Dict[str, Any]:
        ...
        return {
            ...
            "message": "Primary key check not configured",
        }
    ...
    def _check_foreign_keys(self, df: DataFrame) -> Dict[str, Any]:
        ...
        return {
            "status": "not_implemented",
            "message": "Foreign key check not configured",
        }
    ...
    def _check_data_ranges(self, df: DataFrame) -> Dict[str, Any]:
        ...
        return {
            "status": "not_implemented",
            "message": "Data range check not configured",
        }
    ...
    def _check_data_formats(self, df: DataFrame) -> Dict[str, Any]:
        ...
        return {
            "status": "not_implemented",
            "message": "Data format check not configured",
        }
    ...
    def _check_metric_consistency(self, df: DataFrame) -> Dict[str, Any]:
        ...
        return {
            "status": "not_implemented",
            "message": "Metric consistency check not configured",
        }
    ...
    def _check_aggregation_accuracy(self, df: DataFrame) -> Dict[str, Any]:
        ...
        return {
            "status": "not_implemented",
            "message": "Aggregation accuracy check not configured",
        }
    ...
    def _generate_recommendations(
        ...
        for column, null_info in null_analysis.items():
            if null_info.get("exceeds_threshold", False):
                recommendations.append(
                    f"Column '{column}' has {null_info['null_percentage']:.1f}% nulls - consider data cleaning"
                )
        ...
        for column, type_info in data_type_analysis.items():
            if type_info.get("has_issues", False):
                recommendations.append(
                    f"Column '{column}' has data type issues - review data quality"
                )
        ...
        if quality_score < self.config.validation_config.quality_threshold * 100:
            recommendations.append(
                f"Overall quality score ({quality_score:.1f}) below threshold - review data quality"
            )
    ...
    def get_validation_summary(self) -> Dict[str, Any]:
        ...
        if self.validation_results:
            ...
            summary["overall_quality_score"] = total_score / len(
                self.validation_results
            )
