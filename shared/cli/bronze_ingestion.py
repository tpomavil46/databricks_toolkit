...
class BronzeIngestion:
    ...
    def ingest_to_bronze(
        self, source_path: str, bronze_table_name: str, project_name: str = "default"
    ):
        """
    ...
    def _add_bronze_metadata(self, df, source_path: str):
        ...
        """
        bronze_df = (
            df.withColumn("_bronze_ingestion_timestamp", current_timestamp())
...
def bronze_ingestion(
    source_path: str, bronze_table_name: str, project_name: str = "default"
):
    """
...
def main():
    ...
    parser.add_argument(
        "--bronze-table-name", type=str, required=True, help="Name for the bronze table"
    )
    parser.add_argument(
        "--project-name",
        type=str,
