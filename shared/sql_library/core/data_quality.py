...
""",
    ...
    def run_quality_suite(
        self, table_name: str, checks: List[str], parameters: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def search_checks(self, query: str) -> List[QualityCheck]:
        ...
        for check in self.checks.values():
            if (
                query_lower in check.name.lower()
                or query_lower in check.description.lower()
                or query_lower in check.category.lower()
            ):
